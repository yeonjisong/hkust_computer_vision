...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == 'rnn':
            ...
            # Backward pass
            back, grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(dloss, cache_score)
            dx, dh0, grads['Wx'], grads['Wh'], grads['b'] = rnn_backward(back, cache_h)
        else:
            ...
            # Backward pass
            back, grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(dloss, cache_score)
            dx, dh0, grads['Wx'], grads['Wh'], grads['b'] = lstm_backward(back, cache_h)    
